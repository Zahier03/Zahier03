...
function getHtmlComponents() {
  return [
    ...
    {type: "button", name: "Button", properties: {width: "100px", text: "Click Me", backgroundColor: "#4CAF50", color: "white", padding: "10px", borderRadius: "4px"}},
    {type: "input", name: "Text Input", properties: {width: "150px", placeholder: "Enter text...", padding: "8px"}},
    {type: "select", name: "Dropdown", properties: {width: "150px", options: ["Option 1", "Option 2", "Option 3"], padding: "8px"}},
    {type: "table", name: "Table", properties: {width: "200px", rows: 3, columns: 3, borderCollapse: "collapse"}},
    {type: "label", name: "Label", properties: {text: "Text Label", fontWeight: "bold"}},
    {type: "output", name: "Output Display", properties: {width: "200px", height: "100px", padding: "10px", backgroundColor: "#f9f9f9", border: "1px solid #ddd", overflow: "auto", fontFamily: "monospace"}},
    {type: "form", name: "Form", properties: {width: "300px", padding: "15px", backgroundColor: "#f0f0f0", border: "1px solid #ddd", borderRadius: "5px"}},
    {type: "textarea", name: "Text Area", properties: {width: "200px", height: "100px", padding: "8px", resize: "both"}},
    {type: "checkbox", name: "Checkbox", properties: {text: "Check me", checked: false}},
    {type: "radio", name: "Radio Button", properties: {text: "Select me", name: "radioGroup", value: "option1"}}
  ];
}
